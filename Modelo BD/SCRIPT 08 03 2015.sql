...
/* Created on:     08/04/2015 22:12:36                          */
/*==============================================================*/
...
/*==============================================================*/
/* Index: DOCENTE_DOCUMENTOS_FK                                 */
/*==============================================================*/
create  index DOCENTE_DOCUMENTOS_FK on ARCHIVO_BASE (
ID_DOCENTE
);
...
alter table ARCHIVO_BASE
   add constraint FK_ARCHIVO__DOCENTE_D_DOCENTE foreign key (ID_DOCENTE)
