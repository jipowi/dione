...
/* Created on:     15/04/2015 21:30:42                          */
/*==============================================================*/
...
create table ARCHIVO_BASE (
   ...
   DESCRIPCION_DOCUMENTO TEXT                 null,
...
create table CUMPLIMIENTO (
   ...
   ID_MATERIA_SYLLABUS  INT4                 null,
   PORCENTAJE_OBJETIVOS DECIMAL              null,
   PORCENTAJE_COMPETENCIAS DECIMAL              null,
   PORCENTAJE_RESULTADOS DECIMAL              null,
   EFECTIVIDAD          DECIMAL              null,
   constraint PK_CUMPLIMIENTO primary key (ID_CUMPLIMIENTO)
);

/*==============================================================*/
/* Index: CUMPLIMIENTO_PK                                       */
/*==============================================================*/
create unique index CUMPLIMIENTO_PK on CUMPLIMIENTO (
ID_CUMPLIMIENTO
);

/*==============================================================*/
/* Index: MATERIA_CUMPLIMIENTO_FK                               */
/*==============================================================*/
create  index MATERIA_CUMPLIMIENTO_FK on CUMPLIMIENTO (
ID_MATERIA_SYLLABUS
);
...
create table DOCUMENTO_DOCENTE (
   ID_DOC_DOCENTE       SERIAL               not null,
   ID_ARCHIVO           INT4                 null,
   ID_DOCENTE           INT4                 null,
   constraint PK_DOCUMENTO_DOCENTE primary key (ID_DOC_DOCENTE)
);

/*==============================================================*/
/* Index: DOCUMENTO_DOCENTE_PK                                  */
/*==============================================================*/
create unique index DOCUMENTO_DOCENTE_PK on DOCUMENTO_DOCENTE (
ID_DOC_DOCENTE
);

/*==============================================================*/
/* Index: DOCENTE_DOC_FK                                        */
/*==============================================================*/
create  index DOCENTE_DOC_FK on DOCUMENTO_DOCENTE (
ID_DOCENTE
);

/*==============================================================*/
/* Index: DOC_DOCENTE_FK                                        */
/*==============================================================*/
create  index DOC_DOCENTE_FK on DOCUMENTO_DOCENTE (
ID_ARCHIVO
);
...
alter table CUMPLIMIENTO
   add constraint FK_CUMPLIMI_MATERIA_C_MATERIA_ foreign key (ID_MATERIA_SYLLABUS)
      references MATERIA_SYLLABUS (ID_MATERIA_SYLLABUS)
      on delete restrict on update restrict;
...
alter table DOCUMENTO_DOCENTE
   add constraint FK_DOCUMENT_DOCENTE_D_DOCENTE foreign key (ID_DOCENTE)
      references DOCENTE (ID_DOCENTE)
      on delete restrict on update restrict;

alter table DOCUMENTO_DOCENTE
   add constraint FK_DOCUMENT_DOC_DOCEN_ARCHIVO_ foreign key (ID_ARCHIVO)
      references ARCHIVO_BASE (ID_ARCHIVO)
      on delete restrict on update restrict;
